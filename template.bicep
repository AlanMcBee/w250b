...
resource serverfarms_ASP_rgitsdessredcapdev_01_name_resource 'Microsoft.Web/serverfarms@2022-03-01' = {
  ...
  tags: {
    ...
    'ACCOUNTABILITY-Cherwell Change Control': ''
    'ACCOUNTABILITY-Cost Center': ''
    'ACCOUNTABILITY-Date Created': '2023-01-05T22:14:58.7401388Z'
    'ACCOUNTABILITY-Owner': ''
    'ACCOUNTABILITY-Program': ''
    ENVIRONMENT: ''
    'SECURITY-Criticality': ''
...
resource sites_redcapwebwinrxnwnphyrehrs_name_resource 'Microsoft.Web/sites@2022-03-01' = {
  name: sites_redcapwebwinrxnwnphyrehrs_name
  location: 'West US'
  tags: {
    displayName: 'WebApp'
    'ACCOUNTABILITY-Business Unit': ''
  ...
  properties: {
    ...
    hostNameSslStates: [
      ...
      {
        name: '${sites_redcapwebwinrxnwnphyrehrs_name}.scm.azurewebsites.net'
        sslState: 'Disabled'
        hostType: 'Repository'
      }
    ]
    serverFarmId: serverfarms_ASP_rgitsdessredcapdev_01_name_resource.id
    reserved: false
    isXenon: false
    hyperV: false
...
resource sites_redcapwebwinrxnwnphyrehrs_name_ftp 'Microsoft.Web/sites/basicPublishingCredentialsPolicies@2022-03-01' = {
  parent: sites_redcapwebwinrxnwnphyrehrs_name_resource
  name: 'ftp'
  location: 'West US'
  tags: {
    displayName: 'WebApp'
...
resource sites_redcapwebwinrxnwnphyrehrs_name_web 'Microsoft.Web/sites/config@2022-03-01' = {
  parent: sites_redcapwebwinrxnwnphyrehrs_name_resource
  name: 'web'
  location: 'West US'
  tags: {
...
resource storageAccounts_stcdphessredcapdev01_name_default_redcap 'Microsoft.Storage/storageAccounts/blobServices/containers@2022-05-01' = {
  parent: storageAccounts_stcdphessredcapdev01_name_default
  name: 'redcap'
  properties: {
